...
module.exports = function mongooseIntl(schema, options) {
  if (
    !options ||
    !options.languages ||
  ...
  schema.eachPath(function (path, schemaType) {
    ...
    schema
      ...
      .get(function () {
        ...
        let lang = owner.getLanguage();
        let langSubDoc = (this.$__getValue || this.getValue).call(this, path);
    ...
    pluginOptions.languages.forEach(function (lang) {
      let langOptions = extend({}, schemaType.options);
